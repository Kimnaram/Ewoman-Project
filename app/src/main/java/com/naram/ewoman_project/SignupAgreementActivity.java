...
public class SignupAgreementActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        personalinfo_text = "1. 개인정보 수집목적 및 이용목적\n\n" +
                "(1) 홈페이지 회원 가입 및 관리\n" +
        ...
        tv_personalinfo_form.setText(personalinfo_text);
        tv_personalinfo_form.setMovementMethod(new ScrollingMovementMethod());
